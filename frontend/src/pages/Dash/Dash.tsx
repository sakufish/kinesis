...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="h-screen bg-black text-white relative p-8">
      ...
      {/* Text section */}
      <div className="absolute top-32 left-36 w-2/3 z-20"> {/* Adjusted left to move content to the right */}
      ...
      <div className="absolute top-[350px] left-48 z-20">
        ...
        {/* MY ACHIEVEMENTS (offset to the right) */}
        <div 
          className="relative flex items-center justify-center cursor-pointer"
          onMouseEnter={() => setHoveredIcon('ACHIEVEMENTS')}
          onMouseLeave={() => setHoveredIcon(null)}
        >
          <div className="absolute top-[-3rem] left-[18rem] transform text-xl font-medium z-20 italic">
            MY ACHIEVEMENTS
          </div>
